...
function getShapeSource(id, source) {
	const sourceProps = {};
	if (source.getData && typeof source.getData === 'string') {
		sourceProps.url = source.getData;
	} else if (source.getData && typeof source.getData === 'object') {
		sourceProps.shape = source.getData;
	}
