 ...
 */
class MapxusPointAnnotationView extends NativeBridgeComponent(React.PureComponent) {
  static propTypes = {
    ...viewPropTypes,

    /**
     * Mark annotaion which building it is located.
     */
    buildingId: PropTypes.string,

    /**
     * Mark annotaion which floor it is located.
     */
...
const AnnView = requireNativeComponent(
  NATIVE_MODULE_NAME,
...
export default MapxusPointAnnotationView;
