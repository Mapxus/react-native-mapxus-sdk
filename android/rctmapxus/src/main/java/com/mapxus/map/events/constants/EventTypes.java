...
public class EventTypes {
    ...
    public static final String MAP_ON_LOCATION_CHANGE = "locationchange";
    public static final String MAP_ON_LOCATION_STARTED = "locationstart";
    public static final String MAP_ON_LOCATION_STOPPED = "locationstop";
    public static final String MAP_ON_LOCATION_ERROR = "locationerror";
    public static final String MAP_ON_LOCATION_COMPASS_CHANGE= "compasschanged";
}
