...
public class GeoJSONUtils {
    ...
    public static com.mapxus.map.mapxusmap.api.map.model.LatLng toMapxusLatLng(Point point) {
        if (point == null) {
            return null;
        }
        return new com.mapxus.map.mapxusmap.api.map.model.LatLng(point.latitude(), point.longitude());
    }
