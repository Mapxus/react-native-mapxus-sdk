package com.mapxus.map.components.camera;
...
import com.mapxus.map.events.MapUserTrackingModeEvent;
import com.mapxus.map.events.MapChangeEvent;
import com.mapxus.map.location.LocationManager;
import com.mapxus.map.location.UserLocation;
...
public class RCTMGLCamera extends AbstractMapFeature {
    ...
    private void setInitialCamera() {
        if (mDefaultStop != null) {
            ...
            mDefaultStop.setMode(com.mapxus.map.components.camera.constants.CameraMode.NONE);
