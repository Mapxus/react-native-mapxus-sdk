...
- (MGLAnnotationView *)mapView:(MGLMapView *)mapView viewForAnnotation:(id<MGLAnnotation>)annotation
{
    ...
    } else if ([annotation isKindOfClass:[MXRNPointAnnotation class]]) {
        MXRNPointAnnotation *rctAnnotation = (MXRNPointAnnotation *)annotation;
        MXPointAnnotationView *rctAnnotationView = rctAnnotation.annotationView;
        return [rctAnnotationView getAnnotationView];
    }
    return nil;
}
...
- (void)mapView:(MGLMapView *)mapView didSelectAnnotation:(nonnull id<MGLAnnotation>)annotation
{
    if ([annotation isKindOfClass:[RCTMGLPointAnnotation class]]) {
        ...
        MXRNPointAnnotation *rctAnnotation = (MXRNPointAnnotation *)annotation;
        MXPointAnnotationView *rctAnnotationView = rctAnnotation.annotationView;
        if (rctAnnotationView.onSelected != nil) {
            RCTMGLMapTouchEvent *event = [RCTMGLMapTouchEvent makeAnnotationTapEvent:rctAnnotationView];
            rctAnnotationView.onSelected([event toJSON]);
        }
    }
}
...
- (void)mapView:(MGLMapView *)mapView didDeselectAnnotation:(nonnull id<MGLAnnotation>)annotation
{
    if ([annotation isKindOfClass:[RCTMGLPointAnnotation class]]) {
        ...
        MXRNPointAnnotation *rctAnnotation = (MXRNPointAnnotation *)annotation;
        MXPointAnnotationView *rctAnnotationView = rctAnnotation.annotationView;
        if (rctAnnotationView.onDeselected != nil) {
            rctAnnotationView.onDeselected(nil);
        }
    }
}
...
- (BOOL)mapView:(MGLMapView *)mapView annotationCanShowCallout:(id<MGLAnnotation>)annotation {
    if ([annotation isKindOfClass:[RCTMGLPointAnnotation class]]) {
        ...
        MXRNPointAnnotation *rctAnnotation = (MXRNPointAnnotation *)annotation;
        MXPointAnnotationView *rctAnnotationView = rctAnnotation.annotationView;
        return rctAnnotationView.calloutView != nil;
    }
    return NO;
}
...
- (UIView<MGLCalloutView> *)mapView:(MGLMapView *)mapView calloutViewForAnnotation:(id<MGLAnnotation>)annotation
{
    if ([annotation isKindOfClass:[RCTMGLPointAnnotation class]]) {
        ...
        MXRNPointAnnotation *rctAnnotation = (MXRNPointAnnotation *)annotation;
        MXPointAnnotationView *rctAnnotationView = rctAnnotation.annotationView;
        return rctAnnotationView.calloutView;
    }
    return nil;
}
